...
public class ContentDetailResponseDto {
    ...
    private final List<ContentDetailImagePathGetResponseDto> detailImageList;
    private final List<RoundInfoGetResponseDto> roundList;

    public static ContentDetailResponseDto of(ContentGetAdminResponseDto contentDto,
            List<ContentDetailImagePathGetResponseDto> detailImageList,
            List<RoundInfoGetResponseDto> roundList) {
